  ...
  return (
    <html lang="en">
      ...
      >
        ...
        {/* Navbar */}
        <nav id="navbar" className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto px-4 py-5">
          {/* Right menu */}
          <div className="flex items-center">
            {/* STILL NOT WORKING: drop down menu doesn't open on small screens */}
            <Link href="/" className="px-3 pr-5 font-darumadrop text-xl">Isabella Linde</Link>
            <div id="navbar-default" className="hidden w-full md:block md:w-auto">
                <ul className="font-base flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0">
                  ...
                  <li><Link href="/videography" className="font-averia px-3 hover:text-secondary transition ease-in-out duration-100 block py-2 text-textSecondary rounded md:bg-transparent md:p-0">Videography</Link></li>
                  <li><Link href="/photography" className="font-averia px-3 hover:text-secondary transition ease-in-out duration-100 block py-2 text-textSecondary rounded md:bg-transparent md:p-0">Photography</Link></li>
                </ul>
            </div>
          </div>
          ...
          <div className="flex items-center text-secondary">
            {/* Socials */}
            <button className="px-2 hover:text-textSecondary transition ease-in-out duration-100">
              <span className="sr-only">E-mail</span>
              <svg className="w-6 h-6" viewBox="0 0 23 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <button data-collapse-toggle="navbar-default" type="button" className="px-3 items-center text-textSecondary md:hidden hover:text-secondary transition ease-in-out duration-100" aria-controls="navbar-default" aria-expanded="false">
