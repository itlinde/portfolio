...
export default function Page() {
    ...
    <div className="flex flex-wrap-reverse md:flex-nowrap max-w-screen-xl mx-auto w-full items-center p-7 justify-center md:space-x-14 mb-20">
        <div className="max-w-md p-4">
            ...
            <p>Hi! I'm Isabella, a front-end enthusiast and lover of really good design. ⭐️</p>
            <br/>
            ...
            <br/>
            <p>When I'm not knee-deep in VS Code, you can find me at concerts and jazz cafés, taking walks with my camera, curled up with a book, and saving up for my next trip abroad. ✈️</p>
        </div>
